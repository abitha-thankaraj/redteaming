...
class SFTDatasetHelper(RLHFDatasetHelperBase):
    ...
    def get_conversations(self):
        ...
        elif self.agent_type == "defender": # All messages are safe. For sft we want all messages to be safe.
...
class RWRDatasetHelper(RLHFDatasetHelperBase):
    ...
    def get_conversations(self):
        ...
        return {
            "conversations": self.raw_data[f"{self.agent_type}_messages"][subsampled_indices].to_list(),
