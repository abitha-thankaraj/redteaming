...
SAMPLE_CONVERSATION = [
    ...
    {
        "role": "assistant",
        "content": "OFFLINE RL is a four letter word."
    }
...
special_token_map = {
    0. : "<|reserved_special_token_247|>",
    1. : "<|reserved_special_token_246|>"
}

# @pytest.fixture
def get_attacker_conversations_and_rewards():
    dataset_helper = RWRDatasetHelper(data_dir=DATA_FILE, 
                                    agent_type="attacker", 
                                    dataset_type = "all", 
...
def test_tokenizer():
    ...
    out = mask_non_assistant_tokens(tokenizer, 
                                    conv, 
                                    tokenizer_separator, 
                                    -100)
