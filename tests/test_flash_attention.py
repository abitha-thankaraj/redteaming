...
Out[15]: 'system\n\nCutting Knowledge Date: December 2023\nToday Date: 26 Jul 2024\n\nuser\n\nHelloassistant\n\nWho are you?user\n\nVoldemortassistant\n\nAny other monikers you go by?user\n\nTom Marvolo Riddleassistant\n\nAvada Kedavra! '    
    ...
    for i in range(len(conversations)):
        ...
        corrupted_flash_attn_op= tokenizer.decode(op1_corrupted.cpu()[i], skip_special_tokens=True)
        ...
        assert corrupted_og == corrupted_flash_attn_op, f"Outputs are not equal for non causally masked conversation {i}"
