...
if __name__ == "__main__":
    ...
    parser.add_argument("--fname", type=str, default="/data/group_data/rl/datasets/redteaming/gen_judge_multiturn_conversation_combined/combined_eval_data.json", help="Path to the json file")
