...
# Variables
FAST_CHAT_MODEL_PATH="meta-llama/Meta-Llama-3.1-8B";
...
# Deploy and infer
./deploy_and_infer.sh $FAST_CHAT_MODEL_PATH $FAST_CHAT_API_PORT $REPO_DIR $CHAT_COMPLETION_MODEL "${FILES[$SLURM_ARRAY_TASK_ID]}"
