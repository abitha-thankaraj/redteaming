#!/bin/bash
#SBATCH --job-name=hard_negatives_best_of_n
...
python /scratch/bcgv/athankaraj/redteaming/scripts/best_of_n_generate.py chunk=$CHUNK dataset_fname=/scratch/bcgv/datasets/redteaming/quality_filtered/hard_negatives_1000.json experiment_desc=gemma_best_of_n/hard_negatives_1000_chunk_$CHUNK
