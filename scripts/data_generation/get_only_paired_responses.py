...
if __name__ == "__main__":
    ...
    data = torch.load(
        "/data/group_data/rl/datasets/redteaming/best_of_n/value_labeled/combined_no_fixed_conversations_value_labeled.pt"
    )
    sft_dataset = select_positives(data)
    torch.save(
        sft_dataset,
        "/data/group_data/rl/datasets/redteaming/best_of_n/value_labeled/sft_combined_no_fixed_conversations_value_labeled.pt",
    )
