...
(1., 1., 1.): ['<SAFE> ', '<SAFE> ', '<SAFE> '],
(1., 1., 0.): ['<SAFE> ', '<SAFE> ', '<UNSAFE> '],
(1., 0., 1.): ['<MODERATE> ', '<UNSAFE> ', '<SAFE> '],
(1., 0., 0.): ['<MODERATE> ', '<UNSAFE> ', '<UNSAFE> '],
(0., 1., 1.): ['<UNSAFE> ', '<SAFE> ', '<SAFE> '],
(0., 1., 0.): ['<UNSAFE> ', '<MODERATE> ', '<UNSAFE> '],
(0., 0., 1.): ['<UNSAFE> ', '<UNSAFE> ', '<SAFE> '],
(0., 0., 0.): ['<UNSAFE> ', '<UNSAFE> ', '<UNSAFE> ']
...
(1., 1., 1.): ['<SAFE> ', '<SAFE> ', '<SAFE> '],
(1., 1., 0.): ['<SAFE> ', '<SAFE> ', '<UNSAFE> <FIX>  '],
(1., 0., 1.): ['<MODERATE> ', '<UNSAFE> <FIX>  ', '<SAFE> '],
(1., 0., 0.): ['<MODERATE> ', '<UNSAFE> <FIX>  ', '<UNSAFE> <FIX>  '],
(0., 1., 1.): ['<UNSAFE> <FIX>  ', '<SAFE> ', '<SAFE> '],
(0., 1., 0.): ['<UNSAFE> <FIX>  ', '<MODERATE> ', '<UNSAFE> <FIX>  '],
(0., 0., 1.): ['<UNSAFE> <FIX>  ', '<UNSAFE> <FIX>  ', '<SAFE> '],
(0., 0., 0.): ['<UNSAFE> <FIX>  ', '<UNSAFE> <FIX>  ', '<UNSAFE> <FIX>  ']
...
def save_labeled_conversations(fname):
    ...
    for record in tqdm(records):
        ...
        rejected_labeled_conversation = label_conversation(rejected_conversation, rejected_reward)
        ...
        new_record = {}
        labeled_repaired_conversation = label_conversation(record["repaired_conversation"], record["rejected_reward"], is_repaired=True)
